...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
   ...
   <!-- MENU -->
    ...
    <section>
     ...
     <h3 align="left"><?php echo $check_code ?>의 강의 정보를 조회합니다</h3></br>
     <div class="table-responsive">
         <table class="table table-bordered table-striped">
             ...
             <thead>
                 ...
                 <th width="10%">강의실 위치</th>
                 <th width="10%">강의료</th>
                 <th width="10%">강의 시작 날짜</th>
                 <th width="10%">강의 종료 날짜</th>
            ...
            $query = "SELECT * FROM cultureland.course 
                               join instructor using (inst_code) 
                               join classroom using(classroom_code)
                               where course_code = '$check_code'";

            $exec = mysqli_query($con,$query);
            while($row = mysqli_fetch_array($exec)){
            echo '<tr><td>' . $row[ 'course_code' ] . '</td><td>'. $row[ 'course_name' ] . '</td>
            <td>' . $row[ 'inst_name' ] . '</td><td>' . $row[ 'classroom_code' ] .  '</td>
            <td>'.$row['classroom_location'].'</td><td>'. $row[ 'course_fee' ] . '</td><td>'. $row[ 'course_open_date' ] . '</td>
            <td>'. $row[ 'course_end_date' ] . '</td></tr>';
             }
        ?>
