...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <section class="navbar navbar-default navbar-static-top" role="navigation">
     ...
     <h3 align="left"><?php echo $s_id ?>이 포함된 아이디 정보를 조회합니다</h3></br>
     <div class="table-responsive">
         <table class="table table-bordered table-striped">
            ...
            $query = "SELECT distinct stu_id,stu_pw,stu_name,stu_phone,stu_email,stu_address
            FROM register
            join student using(stu_code)
            where stu_id like '%$s_id%'
            order by register.admin_code;
            ";
            ...
            <td>'.$row['stu_email'].'</td><td>' . $row[ 'stu_address' ] .  '</td></tr>';
             }
        ?>
