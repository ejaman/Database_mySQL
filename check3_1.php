     ...
     <div class="table-responsive">
         <table class="table table-bordered table-striped">
          ...
          <th width="20%">스케줄</th>
            ...
            $query = "SELECT course_code, course_fee, payment_d, register_date, stu_code, admin_code, course_name, course_schedule, course_fee*0.95 as 'after_d', course_fee*0.05 as 'd_amount'
            FROM register 
